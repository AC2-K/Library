...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"src/atcoder/mincostflow.hpp\"\n\n\n\n#include <algorithm>\n\
    #include <cassert>\n#include <limits>\n#include <queue>\n#include <vector>\n\n\
    #line 1 \"src/atcoder/internal_csr.hpp\"\n\n\n\n#line 5 \"src/atcoder/internal_csr.hpp\"\
    ...
    \   void clear() {\n        payload.clear();\n        pos = 0;\n    }\n    void\
    \ pop() { pos++; }\n};\n\n}  // namespace internal\n\n}  // namespace atcoder\n\
    \n\n#line 12 \"src/atcoder/mincostflow.hpp\"\n\nnamespace atcoder {\n\ntemplate\
    \ <class Cap, class Cost> struct mcf_graph {\n  public:\n    mcf_graph() {}\n\
  ...
  verifiedWith: []
documentation_of: src/atcoder/mincostflow.hpp
layout: document
redirect_from:
- /library/src/atcoder/mincostflow.hpp
- /library/src/atcoder/mincostflow.hpp.html
