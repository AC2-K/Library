...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo judge/math/Primitive Root.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/primitive_root\"\n#line 1 \"template.hpp\"\
    ...
    #line 5 \"test/yosupo judge/math/Primitive Root.test.cpp\"\nunsigned long long\
    \ primitive_root(const unsigned long long p){\n    Rho rho;\n    if(p == 2) return\
  ...
  requiredBy: []
  timestamp: '2023-02-23 23:48:13+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: test/yosupo judge/math/Primitive Root.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo judge/math/Primitive Root.test.cpp
- /verify/test/yosupo judge/math/Primitive Root.test.cpp.html
