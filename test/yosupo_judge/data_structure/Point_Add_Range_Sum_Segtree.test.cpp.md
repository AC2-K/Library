...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_judge/data_structure/Point_Add_Range_Sum_Segtree.test.cpp\"\
    ...
    \ void put(Args... x) {\n    write(x...);\n    putchar_unlocked('\\n');\n}\n};\
    \  // namespace kyopro\n\n/**\n * @brief fastIO\n */\n#line 5 \"test/yosupo_judge/data_structure/Point_Add_Range_Sum_Segtree.test.cpp\"\
    ...
    \ x;\n            kyopro::read(p, x);\n            seg.apply(p, x);\n        }\
    \ else {\n            int l, r;\n            kyopro::read(l, r);\n           \
    \ kyopro::put(seg.fold(l, r));\n        }\n    }\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/point_add_range_sum\"\n\
    #include <iostream>\n#include \"../../../src/data-structure/segtree.hpp\"\n#include\
    \ \"../../../src/stream.hpp\"\ninline long long op(long long x, long long y) {\
    \ return x + y; }\ninline long long e() { return 0; }\nint main() {\n    int n,\
    \ q;\n    kyopro::read(n, q);\n    std::vector<long long> a(n);\n    for (auto&\
    \ aa : a) {\n        kyopro::read(aa);\n    }\n\n    kyopro::segtree<long long,\
    \ op, e> seg(a);\n    while (q--) {\n        int t;\n        kyopro::read(t);\n\
    \        if (!t) {\n            int p, x;\n            kyopro::read(p, x);\n \
    \           seg.apply(p, x);\n        } else {\n            int l, r;\n      \
    \      kyopro::read(l, r);\n            kyopro::put(seg.fold(l, r));\n       \
