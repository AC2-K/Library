...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_judge/polynomial/Sqrt_of_Formal_Power_Series.test.cpp\"\
    \n#define PROBLEM \"https://judge.yosupo.jp/problem/sqrt_of_formal_power_series\"\
    \n\n#line 2 \"src/FormalPowerSeries/FPS.hpp\"\n#include <vector>\n#line 1 \"src/atcoder/convolution.hpp\"\
    \n\n\n\n#include <algorithm>\n#include <array>\n#include <cassert>\n#include <type_traits>\n\
    ...
    \        if (y == 0) {\n            return 1;\n        } else {\n            return\
    \ -1;\n        }\n    }\n    int m = (int)sqrt(p) + 1;\n    hash_map<T, T> mp;\n\
    \    T xm = mod_pow(x, m, p);\n    internal::double_size_uint_t<T> add = 0, g,\
    \ k = (p == 1 ? 0 : 1);\n    while ((g = _gcd(x, p)) > 1) {\n        if (y ==\
    \ k) return add;\n        if (y % g) return -1;\n        y /= g, p /= g, add++;\n\
    \        k = (k * (x / g)) % p;\n    }\n\n    T pr = y;\n    for (int j = 0; j\
    ...
    \ b && (a = b, true);\n}\n\n/**\n * @brief Template\n*/\n#line 7 \"test/yosupo_judge/polynomial/Sqrt_of_Formal_Power_Series.test.cpp\"\
